# Current Agent Chaos Specification

The authoritative specification for the current released version is:

- [Agent Chaos v0.3 Specification](specs/v0.3.md)
...
are defined in the [Project Vision](PROJECT-VISION.md).

See the [documentation index](README.md) for the complete authority map and specification states.
