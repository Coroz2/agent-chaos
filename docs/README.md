...
| [v0.5 Specification](specs/v0.5.md) | Authoritative contract for the current released v0.5 behavior. |
| [v0.4 Specification](specs/v0.4.md) | Immutable contract for the released v0.4 behavior. |
